...
int main (int argc, char *args[])
{
    ...
    GtkWidget *window, *hbox, *button1, *button2, *button3, *button4;
    ...
    /* The horizontal box initialization done below, other widget are packed in
    this box. */
    ...
    gtk_box_pack_start (GTK_BOX(hbox), button1, 0, 0, 0);
